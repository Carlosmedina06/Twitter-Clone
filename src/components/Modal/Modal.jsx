              ...
              <div className="flex px-4 pt-5 pb-2.5 sm:px-6">
                <div className="w-full">
                  <div className="text-[#6e767d] flex gap-x-3 relative">
                    ...
                    <img alt="" className="h-11 w-11 rounded-full" src={tweet?.userImg} />
                    <div>
                      <div className="inline-block group">
                        <h4 className="font-bold text-[#d9d9d9] inline-block text-[15px] sm:text-base">
                          {tweet?.username}
                        </h4>
                        <span className="ml-1.5 text-sm sm:text-[15px]">@{tweet?.tag} </span>
                      </div>{' '}
                      ·{' '}
                      <span className="hover:underline text-sm sm:text-[15px]">
                        <Moment fromNow>{tweet?.timestamp?.toDate()}</Moment>
                      </span>
                      <p className="text-[#d9d9d9] text-[15px] sm:text-base">{tweet?.text}</p>
                    </div>
                  </div>

                  <div className="mt-7 flex space-x-3 w-full">
                    <img alt="" className="h-11 w-11 rounded-full" src={session.user.image} />
